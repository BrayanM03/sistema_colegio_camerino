...
if (isset($_SESSION["id"])) {
    if($_SESSION['rol'] == 2){
        ...
        header("Location:documentos-subidos.php");
    }
}else{
...
<head>
    ...
    <title>Solicitudes | IIBGV manager</title>
...
<body>
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-md-6">
                            <h1 class="h3 mb-3">Solicitudes usuarios</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Solicitudes usuario</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
    ...
    <!-- Mis scripts -->
    <script src="js/solicitudes/traer-lista-solicitudes.js"></script>
