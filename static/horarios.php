...
<head>
    ...
    <title>Horarios | IIBGV manager</title>
...
<body>
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        ...
                        <a href="nuevo-horario.php" style="text-decoration: none; color:white;"> <div class="btn btn-success" >
                               Crear horario</div></a>
                        </div>
                    </div>
    ...
    <script src="js/horarios/traer-lista-horarios.js"></script>
