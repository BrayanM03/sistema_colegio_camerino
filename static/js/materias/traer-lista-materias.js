$(document).ready(function () {
  ...
  function reloadTable(){
    ...
    console.log(role);
      tabla = $('#example').DataTable({
          ...
          destroy:true,
          ajax:{
              url: '../servidor/materias/server_processing.php',
              dataType: 'json'
          },
          responsive: true,
          order: [0, 'desc'],
          columns:  [
              ...
              { data:1, title:'Nombre'},
              { data:2, title:'Codigo' }, 
              { data:4, title:'Valor creditos'},
              { data:5, title:'Estatus', render:(data)=>{
              ...
              { data:null, title:'Opciones', render: function(row){
                 ...
                 if(role == 1){
                  ...
                  <div class='row'>
                      ...
                      <div onclick="editarMateria(${row[0]})" class="btn btn-primary">
                          <i class="fa-solid fa-pen-to-square"></i>
                      </div>
                          <div class="btn btn-danger" onclick="desactivarMateria(${row[0]})"><i class="fa-solid fa-trash"></i></div>
                      </div>
                  </div>
                  `
                } else{
  ...
  function editarMateria(id_materia){
    $.ajax({
      type: "post",
      url: "../servidor/materias/obtener-info-materia.php",
      data: {id_materia},
      dataType: "json",
      success: function (response) {
        if(response.estatus){
          Swal.fire({
            ...
            if(r.isConfirmed){
              ...
              $.ajax({
                type: "post",
                url: "../servidor/materias/actualizar.php",
