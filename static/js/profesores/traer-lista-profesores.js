$(document).ready(function () {
    ...
    tabla = $('#example').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: '../servidor/profesores/server_processing.php',
            dataType: 'json'
        },
        responsive: true,
        order: [0, 'desc'],
        columns:  [
            ...
            { data:3, title:'Pais' },
            { data:4, title:'Ciudad', render: function(display,data,row){
                return row[4]+ ', ' + row[5];
            }},
            { data:6, title:'Telefono' },
            { data:7, title:'Correo' },
            { data:null, title:'Opciones', render: function(row){
              if(role == 1){
                ...
                <div class="btn btn-primary" onclick="editarSolicitud(${row[8]}, false)">
                    <i class="fa-solid fa-pen-to-square"></i>
                </div>
                    <div class="btn btn-danger" onclick="cancelarUsuario(${row[0]})"><i class="fa-solid fa-trash"></i></div>
                </div>
                </div>
                `
              }else{
