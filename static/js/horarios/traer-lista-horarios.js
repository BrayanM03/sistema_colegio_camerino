  ...
  function reloadTable(){
    const role = $('#role').attr("role");
      tabla = $('#example').DataTable({
          ...
          destroy:true,
          ajax:{
              url: '../servidor/horarios/server_processing.php',
              dataType: 'json'
          },
          responsive: true,
          order: [0, 'desc'],
          columns:  [
              { data:0, title:'#' },
              { data:1, title:'Nombre'}, 
              { data:2, title:'Estatus', render:(data)=>{
              ...
              { data:null, title:'Opciones', render: function(row){
                if(role == 1){
                  ...
                  <div class="btn btn-primary" onclick="editarSolicitud(${row[8]}, false)">
                      ...
                      <div class="btn btn-danger" onclick="cancelarHorario(${row[0]})"><i class="fa-solid fa-trash"></i></div>
                  </div>
                  </div>
                  `
                }else{
